export const API_ROUTES = [
      { 
        ...
        difficulty: "hard", 
        hasCableCar: true,
        description: "Kasprowy Wierch (1987 m) is a iconic peak in the Western Tatras on the Polish-Slovak border, renowned as Poland's premier high-mountain skiing area and a popular tourist destination. Accessible via a scenic cable car from Kuźnice, it offers breathtaking panoramic views of the Tatras and a unique alpine experience.",
        image: "/assets/images/kasprowy-wierch.jpg"
      },
      { 
        id: 2, 
        name: "Morskie Oko", 
      ...
      { 
        ...
        difficulty: "easy", 
        hasCableCar: true,
        description: "Gubałówka is a popular mountain ridge and tourist destination rising 1,123 meters above sea level, located directly north of the town of Zakopane in southern Poland. It is widely considered one of the best vantage points in the region, offering a famous panoramic view of the entire Tatra Mountain range and the town of Zakopane below.",
        image: "/assets/images/gubalowka.jpg"
      },
      { 
        id: 4, 
